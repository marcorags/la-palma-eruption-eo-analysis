...
The repository supports two levels of execution:

1. Running the downstream analysis from the canonical unified datastack.
2. Rebuilding a candidate unified datastack from preprocessed Earth Observation and auxiliary inputs.
...
The public workflow therefore starts from either:
...
Only this README and selected metadata documentation are intended to be tracked by Git. Raster, NetCDF, and GeoPackage files remain local.
